...
const LandingPage = () => {
  ...
  return (
    <> 
      ...
      <div className='w-full min-h-full bg-[#FFFCEF] relative mt-10'>
            ...
            <div className='flex flex-col items-center gap-8'>
              <div className='grid grid-cols-1 md:grid-cols-3 gap-8 w-full'>
                {APP_FEATURES.slice(0, 3).map((feature) => (
                  <div 
                    key={feature.id}
                    className='bg-[#FFFEF8] p-6 rounded-xl shadow-md hover:shadow-lg shadow-amber-100 transition border border-amber-100'
                  >
      ...
      onClose={() => {
        ...
        setCurrentPage('login'); // Reset to login page when modal closes
      }}
      hideHeader
      >
        <div>
